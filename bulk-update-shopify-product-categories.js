...
function normalizeCategoryId(
  ...
  return `gid://shopify/TaxonomyCategory/${categoryId}`
}
...
async function createStagedUpload(
  ...
  const variables = {
    input: [
      {
        filename:
          `bulk-category-update-${chunkNumber}.jsonl`,
...
async function run() {
  log("======================================")
  log("SHOPIFY CATEGORY UPDATE STARTED")
  log("======================================")
  ...
  log("======================================")
  log("SHOPIFY CATEGORY UPDATE FINISHED")
  log("======================================")
}
