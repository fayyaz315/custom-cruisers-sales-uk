...
const INPUT_FILE = path.join(
  ...
  "products-descriptions.jsonl"
)

const OUTPUT_DIRECTORY = path.join(
  __dirname,
  "shopify-description-update"
)
...
function updateDescription(
  ...
  const replacements = [
    {
      pattern:
        /<h3>\s*Product Information\s*<\/h3>/gi,

      replacement:
        `<h3>Product Information: ${cleanTitle}</h3>`
    },

    {
      pattern:
        /<h3>\s*Product Attributes\s*<\/h3>/gi,

      replacement:
        `<h3>Product Attributes: ${cleanTitle}</h3>`
    }
  ]
...
async function createStagedUpload(
  ...
  const variables = {
    input: [
      {
        filename:
          `bulk-description-update-${chunkNumber}.jsonl`,
...
async function run() {
  log("======================================")
  log("SHOPIFY DESCRIPTION UPDATE STARTED")
  log("======================================")
  ...
  log("======================================")
  log("SHOPIFY DESCRIPTION UPDATE FINISHED")
  log("======================================")
}
